          ...
          {subjects.map((subject) => (
            ...
            >
              ...
              <button
                type="button"
                disabled={isPending}
                className="shrink-0 text-xs font-medium text-text-secondary transition-transform duration-200 hover:text-text-primary active:scale-85 disabled:opacity-50"
                onClick={() =>
